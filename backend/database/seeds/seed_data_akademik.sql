-- ============================================================
-- SEED DATA AKADEMIK - SMKS RAJASA SURABAYA
-- Jalankan SETELAH schema sudah ada di database
-- ============================================================
...
-- 3. JAM PEMBELAJARAN
INSERT INTO `jam_pembelajaran` (`jam_ke`, `label_jam`, `waktu_mulai`, `waktu_selesai`, `tipe_hari`, `status`) VALUES
  (1, 'Jam ke-1',  '07:00', '07:45', 'normal', 'aktif'),
  (2, 'Jam ke-2',  '07:45', '08:30', 'normal', 'aktif'),
  (3, 'Jam ke-3',  '08:30', '09:15', 'normal', 'aktif'),
  (4, 'Jam ke-4',  '09:30', '10:15', 'normal', 'aktif'),
  (5, 'Jam ke-5',  '10:15', '11:00', 'normal', 'aktif'),
  (6, 'Jam ke-6',  '11:00', '11:45', 'normal', 'aktif'),
  (7, 'Jam ke-7',  '12:30', '13:15', 'normal', 'aktif'),
  (8, 'Jam ke-8',  '13:15', '14:00', 'normal', 'aktif'),
  (1, 'Jam ke-1 (Jumat)', '07:00', '07:40', 'jumat', 'aktif'),
  (2, 'Jam ke-2 (Jumat)', '07:40', '08:20', 'jumat', 'aktif'),
  (3, 'Jam ke-3 (Jumat)', '08:20', '09:00', 'jumat', 'aktif'),
  (4, 'Jam ke-4 (Jumat)', '09:30', '10:10', 'jumat', 'aktif'),
  (5, 'Jam ke-5 (Jumat)', '10:10', '10:50', 'jumat', 'aktif'),
  (6, 'Jam ke-6 (Jumat)', '10:50', '11:30', 'jumat', 'aktif')
...
-- 5. DEMO SISWA (dengan nisn yang wajib diisi)
