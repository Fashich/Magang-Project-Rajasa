...
function TahunAjaranTab({ data, onReload, showToast }) {
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      showToast(t.ad_berhasil_disimpan)
        ...
        <form onSubmit={handleAdd} class="pg-form">
          ...
          <div class="pg-form-actions">
            ...
            <button type="submit" class="pg-btn pg-btn--primary" disabled={saving}>
              {saving ? t.ad_menyimpan : t.ad_simpan}
            </button>
          </div>
        </form>
      </Modal>
...
function JurusanTab({ data, onReload, showToast }) {
  ...
  async function handleDelete(id, nama) {
    ...
    try {
      ...
      showToast(t.ad_berhasil_dihapus)
      onReload()
    } catch (err) { showToast(err.message, 'error') }
    finally { setSaving(false) }
  }
  ...
  const JurusanForm = ({ onSubmit, submitLabel }) => (
    <form onSubmit={onSubmit} class="pg-form">
      ...
      <div class="pg-form-actions">
        ...
        <button type="submit" class="pg-btn pg-btn--primary" disabled={saving}>
          {saving ? t.ad_menyimpan : submitLabel}
        </button>
      </div>
    </form>
  )
  ...
  return (
    <div class="pg-section">
      <div class="pg-section-toolbar">
        ...
        >
          {saving ? t.ad_menyimpan : dirty ? t.ad_simpan_perubahan : t.ad_berhasil_disimpan}
        </button>
      </div>
...
export default function PengaturanPage({ lang }) {
  const t = T[lang] || T.id
